            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row gap-x-16">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        @elseif($fundraisingWithdrawal->has_sent)
                        ...
                        <div class="">
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{$fundraisingWithdrawal->fundraising->fundraiser->user->name}}</h3>
                        </div>
                    </div>
                    <div>
